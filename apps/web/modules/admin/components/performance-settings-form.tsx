...
import { savePerformanceSettingsAction } from "@/app/(shell)/admin/actions";

/**
 * ฟอร์มตั้งเกณฑ์คะแนนผลงานของบริษัท — ใช้ร่วมกันสองที่:
 *   /hr/settings/scoring        (ตั้งค่าของระบบบุคคล — ไม่ต้องเด้งออกไปหลังบ้าน)
 *   /admin/performance/settings (หลังบ้าน สำหรับคนที่ไม่ได้ใช้โมดูลบุคคล)
 * ข้อมูลชุดเดียวกัน (core.performance_settings) บันทึกด้วย action เดียวกัน
 *
...
export function PerformanceSettingsForm({ settings: s }: { settings: PerformanceSettings }) {
  ...
  return (
    <form action={savePerformanceSettingsAction} className="flex flex-col gap-4">
      ...
      <SectionCard title="งานและรายงาน" description="จากโมดูลรายงานและงาน">
