...
import { DeleteEnrollmentsButton } from "./delete-enrollments-button";
    ...
    <HrPage
      ...
      load={async () => {
        ...
        return (
          ...
          <SettingsSubnav active="/hr/settings/devices" />
                  ...
                  {canManage && (
                    <Td>
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {device.has_active_credential && (
                          <RevokeDeviceButton deviceId={device.id} deviceCode={device.device_code} />
                        )}
                      </div>
                    </Td>
                  )}
                      ...
                      {liveEnrollments.map((en) => {
                        ...
                        return (
                          <tr key={en.id} className="hover:bg-(--bg-soft)">
                            ...
                            <Td>
                              <DeleteEnrollmentsButton
                                employmentId={en.employment_id}
                                employeeName={employmentName.get(en.employment_id) ?? "คนนี้"}
                              />
                            </Td>
                          </tr>
                        );
