  ...
  return (
    <aside className="hidden w-[200px] shrink-0 flex-col border-r border-(--line) bg-(--bg) lg:flex">
      ...
      <Link
        ...
        //
        // ไม่มี border-b ตรงนี้ตั้งใจ — แถวนี้กับแถวหัวข้อโมดูลด้านล่างรวมเป็น
        // บล็อกหัวราง "เดียว" ในสายตา คั่นด้วยเส้นเดียวก่อนเข้าเมนู แทนที่จะมี
        // เส้นแบ่งระหว่างโลโก้กับหัวข้อโมดูลด้วย ซึ่งทำให้ดู "แบ่งกันมากเกินไป"
        // เป็น 3 กล่องซ้อนกันแทนที่จะเป็นหัวราง 1 ก้อน + เมนู
        className="flex h-[60px] shrink-0 items-center px-4 sm:px-6 transition-colors hover:bg-(--bg-soft)"
      >
        <Logo size="md" />
      </Link>
