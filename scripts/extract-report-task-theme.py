...
⚠ เครื่องมือของการพอร์ตครั้งก่อน — **ไม่ใช้ในงานประจำวันแล้ว**
ตั้งแต่ 2026-08-11 Smartboss เป็นเจ้าของโมดูลรายงานและงานเต็มตัว ไม่ดึงจาก upstream อีก
เก็บไว้เผื่อวันหนึ่งอยากหยิบของบางส่วนจาก workspace มาเทียบ — ซึ่งวันนั้นจะไม่ใช่
การเขียนทับทั้งโฟลเดอร์แล้ว ต้องไล่ merge ทีละไฟล์ (ดู docs/report_task_port.md)
